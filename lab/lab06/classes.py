...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for deck_card in opponent.deck.cards[:]:
            if deck_card.attack == other_card.attack:
                opponent.deck.cards.remove(deck_card)
            elif deck_card.defense == other_card.defense:
                opponent.deck.cards.remove(deck_card)
